            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('admin.galeri.update', $galeri) }}" method="POST"
                        ...
                        <div class="form-card">
                            <h3 class="form-title"><i class="bi bi-pencil-square"></i>Edit Foto Galeri</h3>

                            <div class="form-group-modern">
                                <label for="judul" class="form-label-modern">Judul Foto<span
                            ...
                            <div class="form-group-modern">
                                ...
                                <textarea class="form-control-modern" id="deskripsi" name="deskripsi"
                                    rows="4">{{ old('deskripsi', $galeri->deskripsi) }}</textarea>
                            </div>

                            <div class="form-group-modern">
                                <label for="foto" class="form-label-modern">Upload Foto Baru (Opsional)</label>
                                <input class="file-input-modern form-control" type="file" id="foto" name="foto"
                                    accept="image/*">
                                <div class="file-help-text"><i class="bi bi-info-circle"></i>Kosongkan jika tidak ingin
                                    mengubah foto</div>
                            </div>

                            @if ($galeri->foto)
                                <div class="current-photo">
                                    <p><i class="bi bi-image me-2"></i>Foto Saat Ini:</p>
                                    <img src="{{ asset('storage/' . $galeri->foto) }}" alt="Foto saat ini">
                                </div>
                            @endif
                            ...
                            <div class="form-actions">
                                <a href="{{ route('admin.galeri.index') }}" class="btn-modern btn-cancel"><i
                                        class="bi bi-x-circle"></i>Batal</a>
                                <button type="submit" class="btn-modern btn-submit"><i
                                        class="bi bi-check-circle"></i>Update Foto</button>
                            </div>
                        </div>
                    </form>
