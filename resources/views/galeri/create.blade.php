            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('admin.galeri.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-card">
                            <h3 class="form-title"><i class="bi bi-image-fill"></i>Tambah Foto Baru</h3>
                            ...
                            <div class="form-group-modern">
                                ...
                                <input type="text" class="form-control-modern" id="judul" name="judul"
                                    value="{{ old('judul') }}" placeholder="Masukkan judul foto" required>
                            </div>
                            ...
                            <div class="form-group-modern">
                                <label for="foto" class="form-label-modern">Upload Foto<span
                                        class="required">*</span></label>
                                <input class="file-input-modern form-control" type="file" id="foto" name="foto"
                                    accept="image/*" required>
                                <div class="file-help-text"><i class="bi bi-info-circle"></i>Format: JPG, JPEG, PNG.
                                    Ukuran Maksimal: 2MB</div>
                            </div>
                            ...
                            <div class="form-actions">
                                ...
                                <button type="submit" class="btn-modern btn-submit"><i
                                        class="bi bi-check-circle"></i>Simpan Foto</button>
                            </div>
                        </div>
                    </form>
