            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('admin.berita.update', $berita->id) }}" method="POST"
                        ...
                        @method('PUT')
                        <div class="form-card">
                            <h3 class="form-title"><i class="bi bi-pencil-square"></i>Edit Berita</h3>
                            ...
                            <div class="form-group-modern">
                                <label for="gambar" class="form-label-modern">Upload Gambar Baru (Opsional)</label>
                            ...
                            @if($berita->gambar)
                                <div class="form-group-modern">
                                    <p class="form-label-modern mb-1">Gambar Saat Ini:</p>
                            ...
                            <div class="form-actions">
                                ...
                                <button type="submit" class="btn-modern btn-submit"><i
                                        class="bi bi-check-circle"></i>Update Berita</button>
                            </div>
                        </div>
                    </form>
