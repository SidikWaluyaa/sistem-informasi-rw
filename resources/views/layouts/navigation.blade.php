            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <i class="bi bi-shield-lock-fill text-indigo-500 text-3xl"></i>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.struktur.index')" :active="request()->routeIs('admin.struktur.*')">
                        Struktur
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('penduduk.index')" :active="request()->routeIs('penduduk.*')">
                        Penduduk
                    </x-nav-link>
                    <x-nav-link :href="route('kartu-keluarga.index')" :active="request()->routeIs('kartu-keluarga.*')">
                        Kartu Keluarga
                    </x-nav-link>
                    <x-nav-link :href="route('kk.lookup')" :active="request()->routeIs('kk.lookup.*')">
                        Gabungan
                    </x-nav-link>
                </div>
            </div>
